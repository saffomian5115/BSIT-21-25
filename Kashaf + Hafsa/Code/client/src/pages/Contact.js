    ...
    <div className="page-pt">
      <section className="gc-contact-hero">
        <div className="container">
          ...
          <p className="text-white-50 mx-auto" style={{maxWidth:480,fontSize:'1.05rem'}}>We'd love to hear from you. Send us your feedback, questions, or suggestions.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-4">
              ...
              <p className="text-muted lh-lg mb-4">Have a question? Want to report a problem or share a suggestion? We read every message.</p>

              {[
                {icon:'bi-envelope', title:'Email Us', text:'ai.gastrocare.official@gmail.com', href:'mailto:ai.gastrocare.official@gmail.com'},
                ...
                <div className="d-flex gap-3 align-items-start mb-4" key={i}>
                  ...
                  <div>
                    ...
                    {item.href
                      ? <a href={item.href} className="text-muted small text-decoration-none">{item.text}</a>
                      : <div className="text-muted small">{item.text}</div>}
                  </div>
                </div>
              ))}

              {/* Social Links — Instagram + X only */}
              <h6 className="fw-bold mb-3" style={{color:'var(--gc-primary-dark)'}}>Follow Us</h6>
              <div className="d-flex flex-wrap gap-2 mb-4">
                <a href="https://www.instagram.com/ai.gastrocare.official/" target="_blank" rel="noreferrer" className="gc-social-link">
                  <i className="bi bi-instagram"/> Instagram
                </a>
                <a href="https://x.com/AiBased37955" target="_blank" rel="noreferrer" className="gc-social-link">
              ...
              <div className="bg-white p-4 p-lg-5 rounded-gc shadow-gc">
                ...
                {success && (
                  <div className="gc-success-msg mb-4">
                    ...
                    Thank you! Your feedback has been sent to our email successfully! 📧
                  </div>
                )}
