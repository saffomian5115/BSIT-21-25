        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <div className="input-group">
              ...
              <input type="text" className="form-control border-start-0 ps-0" name="name" placeholder="Your full name" value={form.name} onChange={handleChange} required/>
            </div>
          </div>
          <div className="mb-3">
            ...
            <div className="input-group">
              ...
              <input type="email" className="form-control border-start-0 ps-0" name="email" placeholder="you@example.com" value={form.email} onChange={handleChange} required/>
            </div>
          </div>
          <div className="mb-3">
            ...
            <div className="input-group">
              ...
              <input type={showPw?'text':'password'} className="form-control border-start-0 border-end-0 ps-0" name="password" placeholder="Min. 6 characters" value={form.password} onChange={handleChange} required/>
          ...
          <div className="mb-4">
            ...
            <div className="input-group">
              ...
              <input type={showPw?'text':'password'} className="form-control border-start-0 ps-0" name="confirm" placeholder="Repeat password" value={form.confirm} onChange={handleChange} required/>
            </div>
          </div>
