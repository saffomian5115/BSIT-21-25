...
const features = [
  { icon:'🤖', title:'AI Health Assistant', desc:'Ask anything about gastro health, diet, and wellness. Get intelligent, personalized responses powered by Llama 3.3.' },
  { icon:'👤', title:'Personalized Advice', desc:'AI reads your health profile — age, allergies, medications — and gives advice tailored specifically for you.' },
    ...
    <div className="page-pt">
        ...
        <div className="container position-relative">
          <div className="row align-items-center gy-5">
            <div className="col-lg-7">
              <div className="gc-hero-badge mb-3"><span>✨</span> AI-Powered Health Companion</div>
              <h1 className="fw-bold mb-3">Your <span>Smarter</span> Path<br/>to Better Health</h1>
              <p className="lead mb-4" style={{maxWidth:520}}>
                GastroCare combines AI with your personal health profile to give you truly personalized health guidance — in your language, anytime.
              </p>
            ...
            <div className="col-lg-5 d-none d-lg-block">
              <div className="row g-3">
                {[{icon:'🩺',val:'24/7',lbl:'Always Available'},{icon:'🌐',val:'3',lbl:'Languages'},{icon:'🛡️',val:'100%',lbl:'Private & Secure'},{icon:'⚡',val:'Smart AI',lbl:'AI Powered'}].map((c,i)=>(
      ...
      <section className="gc-section" style={{background:'linear-gradient(135deg,var(--gc-primary-dark),var(--gc-primary))'}}>
        <div className="container text-center">
          <GastroCareLogo size={60} />
          <h2 className="text-white mt-3 mb-3">Ready to Take Control<br/>of Your Health?</h2>
          <p className="text-white-50 mb-4 mx-auto" style={{maxWidth:480}}>
            Join GastroCare for smarter, personalized health decisions. Free, private, and available in your language.
          </p>
