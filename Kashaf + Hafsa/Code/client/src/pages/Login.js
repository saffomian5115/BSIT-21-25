        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-2">
            ...
            <div className="input-group">
              ...
              <input type={showPw?'text':'password'} className="form-control border-start-0 border-end-0 ps-0" name="password" placeholder="Your password" value={form.password} onChange={handleChange} required/>
          ...
          <div className="text-end mb-4">
            <Link to="/forgot-password" className="text-decoration-none small" style={{color:'var(--gc-primary)'}}>
              Forgot Password?
            </Link>
          </div>
